...
public static class RateLimitCompiler
{
    ...
    {
        yield return new XComment(" Generated by apim-rate-limit-compiler. Do not edit manually. Change the source JSON and regenerate this fragment. ");
        ...
        yield return CreateComment(" Compiler: apim-rate-limit-compiler " + GetCompilerVersion(options) + " ");
    }
