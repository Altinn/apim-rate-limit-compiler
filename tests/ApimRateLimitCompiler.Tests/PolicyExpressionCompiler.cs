...
namespace ApimRateLimitCompiler.Tests;
...
public sealed class PolicyExpressionCompiler
{
    ...
    public IPolicyExpressionEvaluator Compile(PolicyExpression expression)
    {
        ...
        var compilation = CSharpCompilation.Create(
            "ApimRateLimitCompilerExpression_" + Guid.NewGuid().ToString("N"),
            [syntaxTree],
            References,
        ...
        var type = assembly.GetType("ApimRateLimitCompiler.Tests.Generated.CompiledPolicyExpression", throwOnError: true)!;
    ...
    private static string CreateSource(PolicyExpression expression)
    {
        ...
        using ApimRateLimitCompiler.Tests;

        namespace ApimRateLimitCompiler.Tests.Generated
        {
